 ...
 */
public abstract class NewAbstractStaticFailoverStrategy implements NewFailoverStrategy {
    private static final Logger LOG =
        LogUtils.getL7dLogger(NewAbstractStaticFailoverStrategy.class);
    ...
    public abstract int getestimatenum();
