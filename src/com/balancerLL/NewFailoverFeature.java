...
public class NewFailoverFeature extends AbstractFeature {

    private NewFailoverStrategy failoverStrategy;
    private NewFailoverTargetSelector targetSelector;
    ...
    protected ConduitSelector initTargetSelector(Endpoint endpoint) {
        NewFailoverTargetSelector selector = getTargetSelector();
    ...
    public NewFailoverTargetSelector getTargetSelector() {
        if (this.targetSelector == null) {
            this.targetSelector = new NewFailoverTargetSelector();
        }
        return this.targetSelector;
    }
    
    public void setTargetSelector(NewFailoverTargetSelector selector) {
        this.targetSelector = selector;
    }
    
    public void setStrategy(NewFailoverStrategy strategy) {
        failoverStrategy = strategy;
    }
    
    public NewFailoverStrategy getStrategy()  {
